...
//     const { backdrop_path, title, homepage, genres, release_date, tagline, overview, original_language, original_title, status, revenue, budget, production_companies, logo_path } = details || {};
//     const { id } = useParams();
